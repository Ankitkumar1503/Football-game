    ...
    <div className="pb-24 px-4 pt-4 bg-football-primary min-h-screen text-football-text transition-colors duration-300">
      ...
      <div className="text-center mb-8">
        <h1 className="text-xl font-bold uppercase tracking-wider text-white">
          FOOTBALLER <span className="font-normal">ATHLETICS</span>
        </h1>
      </div>
      ...
      <div className="space-y-6 text-gray-300 text-sm">
        {/* App Info */}
        <div>
          <h2 className="text-white font-bold uppercase mb-1">TOUCHES™ APP</h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p>
                ...
                has been collected improperly, contact us immediately for
                removal.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Data is NOT retained beyond what is necessary for app
                functionality. Users may request deletion at any time (see
                Section 5).
              </p>
            </div>
            ...
            <div>
              <h3 className="text-white font-bold text-xs mb-1">
                1.8 Your Rights (GDPR / CCPA)
              </h3>
              <p>
                You have the right to: Access your data, Request correction or
                deletion, Withdraw consent, Request a copy of stored data.
              </p>
            </div>

            <div>
              <h3 className="text-white font-bold text-xs mb-1">1.9 Contact</h3>
              <p>
                Email: footballerathletics@gmail.com <br />
        ...
        <div>
          ...
          <p className="text-xs mb-4">Effective Date: January 1, 2026</p>
          ...
          <div className="space-y-4">
            ...
            <div>
              <h3 className="text-white font-bold text-xs mb-1">
                2.2 Purpose of the App
              </h3>
              <p>
                Touches™ is an educational and development tool designed to
                support football training, reflection, and player development
                analysis.
              </p>
              <p className="mt-2">
                <span className="text-white font-bold">Touches™ is NOT:</span>
                <br />A medical tool. A scouting guarantee. A performance
                prediction system.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                You may not: Use Touches™ for unlawful purposes. Attempt to
                extract source code or data. Resell, sublicense, or distribute
                the app. Upload harmful or offensive content.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Footballer Athletics™ shall not be liable for: Loss of data,
                Missed performance outcomes, Coaching or selection decisions,
                Injuries or training outcomes.
              </p>
            </div>
        ...
        {/* 3. Copyright Notice */}
        <div>
          <h2 className="text-white font-bold uppercase mb-1">
            3. COPYRIGHT NOTICE
          </h2>
          <p>
            © 2026 Clem Murdock – Footballer Athletics™ All rights reserved.
          </p>
          <p className="mt-2">
        ...
        <div>
          <h2 className="text-white font-bold uppercase mb-1">
            4. TRADEMARK & THIRD-PARTY DISCLAIMER
          </h2>
          <p>
        ...
        <div>
          <h2 className="text-white font-bold uppercase mb-1">
            5. DATA DELETION INSTRUCTIONS (APP STORE REQUIRED)
          </h2>
          <p className="mb-2">
            Users may request deletion of their data at any time.
          </p>
          <p className="font-bold text-white mb-1">How to Request Deletion</p>
          <ul className="list-none space-y-1">
            <li>Open the Touches™ app</li>
            <li>
              Go to Settings {">"} About {">"} Data & Privacy
            </li>
            <li>Select Request Data Deletion</li>
            <li>Or email: footballerathletics@gmail.com</li>
          </ul>
        ...
        <div>
          ...
          <p className="font-bold text-white">Footballer Athletics™ TOUCHES</p>
          <p>Founder: Coach Clem Murdock</p>
          <p>Email: footballerathletics@gmail.com</p>
        </div>
        ...
        <div className="mt-8 pt-4 border-t border-gray-800 text-center">
          ...
          <p className="text-xs font-bold text-white mt-2 uppercase">
