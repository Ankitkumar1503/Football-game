        ...
        <div className="space-y-4 text-[10px] text-football-text leading-relaxed">
          ...
          <div>
            ...
            <div className="space-y-3 mt-3">
              <div>
                <p className="text-[10px] font-black uppercase tracking-wider text-football-text mb-0.5">
                  1.1 Introduction
                </p>
                <p>
          ...
          <div>
            ...
            <div className="space-y-3 mt-3">
              ...
              <div>
                ...
                <p className="mt-1">
                  <span className="font-black">Touches™ is NOT:</span>
          ...
          <div>
            ...
            <p className="font-black">Footballer Athletics™ TOUCHES</p>
